<div
    class="bg-neutral-primary-soft flex flex-col max-w-sm p-6 border border-default rounded-base shadow-xs dark:bg-neutral-900/60 dark:border-neutral-800 ">
    @if (isset($profile))
    ...
    @if (isset($roles))
        <p class="mb-6 text-sm text-gray-700 dark:text-gray-300">{{ $roles }}</p>
    @endif
